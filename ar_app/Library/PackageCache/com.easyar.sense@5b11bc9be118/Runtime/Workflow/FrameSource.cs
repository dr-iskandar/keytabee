...
namespace easyar
{
    ...
    public abstract class FrameSource : MonoBehaviour
    {
        ...
        /// <summary>
        /// <para xml:lang="en">Frame source type. Usually can be used only after device created.</para>
        /// <para xml:lang="zh">Frame source类型，一般在设备创建之后才可获取。</para>
        /// </summary>
        public abstract Optional<InputFrameSourceType> Type { get; }
        ...
        /// <summary>
        /// <para xml:lang="en">If the frame source is custom camera.</para>
        ...
        /// <para xml:lang="zh">Frame source 是否是自定义相机。</para>
        /// <para xml:lang="zh">所有用户定义的frame source都是自定义相机。AR Engine、Nreal 及 ARFoundation的支持也是通过自定义实现。</para>
        /// <para xml:lang="zh">使用定义相机时，个人版每次启动只能使用100秒。</para>
        /// </summary>
