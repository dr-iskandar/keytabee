...
namespace easyar
{
    ...
    public class ARSession : MonoBehaviour
    {
        ...
        /// <para xml:lang="en">The object must contain one of the following component: <see cref="TargetController"/>, <see cref="SparseSpatialMapRootController"/> or <see cref="EasyAR.Mega.Scene.BlockRootController"/>.</para>
        ...
        /// <para xml:lang="zh">该物体必须包含以下任一组件：<see cref="TargetController"/>, <see cref="SparseSpatialMapRootController"/>或<see cref="EasyAR.Mega.Scene.BlockRootController"/>。</para>
        /// </summary>
