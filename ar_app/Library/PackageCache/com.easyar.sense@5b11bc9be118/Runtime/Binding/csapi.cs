//=============================================================================================================================
//
// EasyAR Sense 4.6.1.10366-981ec3f3e
...
namespace easyar
{
    ...
    internal static partial class Detail
    {
        ...
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void easyar_MegaTracker_setInputFrameSourceType(IntPtr This, InputFrameSourceType type);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern InputFrameSourceType easyar_ARCoreCameraDevice_inputFrameSourceType(IntPtr This);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern InputFrameSourceType easyar_ARKitCameraDevice_inputFrameSourceType(IntPtr This);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern InputFrameSourceType easyar_CameraDevice_inputFrameSourceType(IntPtr This);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern InputFrameSourceType easyar_MotionTrackerCameraDevice_inputFrameSourceType(IntPtr This);
        [DllImport(BindingLibraryName, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
    ...
    public class ObjectTracker : RefBase
    {
        ...
        /// enableRtct默认为false，开启时，如果 `InputFrame`_ 数据中包含时间信息和空间信息，则 `ImageTrackerResult`_ 中的 targetInstances 的 pose 会使用 `RealTimeCoordinateTransform`_ 进行处理。
        /// </para>
        /// </summary>
    ...
    public enum ARCoreDeviceListDownloadStatus
    {
        /// <summary>
        /// <para xml:lang="en">
        /// Download successful.
    ...
    /// </para>
    /// </summary>
    public class ARCoreDeviceListDownloader : RefBase
    {
    ...
    public enum CloudLocalizerStatus
    {
        /// <summary>
        /// <para xml:lang="en">
        /// Unknown error
    ...
    /// </para>
    /// </summary>
    public class CloudLocalizerBlockInstance : RefBase
    {
    ...
    public class CloudLocalizerResult : RefBase
    {
    ...
    public class DeviceAuxiliaryInfo : RefBase
    {
    ...
    /// </para>
    /// </summary>
    public class MegaTrackerBlockInstance : RefBase
    {
    ...
    /// </para>
    /// </summary>
    public class MegaTrackerResult : FrameFilterResult
    {
    ...
    /// </para>
    /// </summary>
    public class MegaTrackerLocalizationResponse : RefBase
    {
    ...
    /// </para>
    /// </summary>
    public class MegaTracker : RefBase
    {
        ...
        public virtual void setInputFrameSourceType(InputFrameSourceType type)
        {
            using (var ar = new Detail.AutoRelease())
            {
                Detail.easyar_MegaTracker_setInputFrameSourceType(cdata, type);
            }
        }
        /// <summary>
        /// <para xml:lang="en">
    ...
    public class ARCoreCameraDevice : RefBase
    {
        ...
        public virtual InputFrameSourceType inputFrameSourceType()
        {
            using (var ar = new Detail.AutoRelease())
            {
                var _return_value_ = Detail.easyar_ARCoreCameraDevice_inputFrameSourceType(cdata);
                return _return_value_;
            }
        }
        /// <summary>
    ...
    public class ARKitCameraDevice : RefBase
    {
        ...
        public virtual InputFrameSourceType inputFrameSourceType()
        {
            using (var ar = new Detail.AutoRelease())
            {
                var _return_value_ = Detail.easyar_ARKitCameraDevice_inputFrameSourceType(cdata);
                return _return_value_;
            }
        }
        /// <summary>
    ...
    public class CameraDevice : RefBase
    {
        ...
        public virtual InputFrameSourceType inputFrameSourceType()
        {
            using (var ar = new Detail.AutoRelease())
            {
                var _return_value_ = Detail.easyar_CameraDevice_inputFrameSourceType(cdata);
                return _return_value_;
            }
        }
        /// <summary>
    ...
    public class MotionTrackerCameraDevice : RefBase
    {
        ...
        public virtual InputFrameSourceType inputFrameSourceType()
        {
            using (var ar = new Detail.AutoRelease())
            {
                var _return_value_ = Detail.easyar_MotionTrackerCameraDevice_inputFrameSourceType(cdata);
                return _return_value_;
            }
        }
        /// <summary>
    ...
    public class Engine
    {
        ...
        {
            if (Detail.easyar_Engine_schemaHash() != 1331383719)
            {
    ...
    /// </para>
    /// </summary>
    public class AccelerometerResultSink : RefBase
    {
    ...
    /// </para>
    /// </summary>
    public class AccelerometerResultSource : RefBase
    {
    ...
    /// </para>
    /// </summary>
    public class LocationResultSink : RefBase
    {
    ...
    /// </para>
    /// </summary>
    public class LocationResultSource : RefBase
    {
    ...
    /// </para>
    /// </summary>
    public class ProximityLocationResultSink : RefBase
    {
    ...
    /// </para>
    /// </summary>
    public class ProximityLocationResultSource : RefBase
    {
    ...
    /// </para>
    /// </summary>
    public enum InputFrameSourceType
    {
        /// <summary>
        /// <para xml:lang="en">
