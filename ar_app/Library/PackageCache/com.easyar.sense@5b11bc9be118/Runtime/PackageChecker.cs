...
#error EasyAR Cloud SpatialMap has been renamed to EasyAR Mega, please upgrade your SDK and tools.
#endif

#if EASYAR_HAVE_MEGA
#error The latest EasyAR Mega Studio is NOT designed to work with this version. Please follow documents to download the correct file.
#warning If you are using it on purpose, just comment out these errors. But NO official support will be provided for possible building or runtime errors caused by this kind of usage.
#endif
